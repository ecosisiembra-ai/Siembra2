...
async function hubLogout() {
  ...
  // Limpiar escuela activa en memoria (forzar nueva selección)
  if (window._escuelaCfg) window._escuelaCfg = { cct:'', nombre:'', plan:'base', nivel_default:'secundaria' };
  try { localStorage.removeItem('siembra_escuela_cfg'); } catch(e) {}
